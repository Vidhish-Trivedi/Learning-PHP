...
/*
  ...
  For example, someone can submit a JS script which will run, not good!!!
*/

if (isset($_POST['submit'])) {
//   $name = $_POST['name'];        // Try passing a JS script here.
//   $email = $_POST['email'];
//   echo $name;
  ...
  // FILTER_SANITIZE_STRING - Convert string to string with only alphanumeric, whitespace, and the following characters - Deprecated _.:/
